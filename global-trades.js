      ...
      return `
        <div style="background: #2a2a2a; border-radius: 8px; padding: 14px; border-left: 3px solid ${isActive ? '#fbbf24' : isWin ? '#10b981' : '#ef4444'};">
          ...
          <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div style="text-align: right;">
              <div style="color: #888; font-size: 11px; margin-bottom: 2px;">Entry</div>
              <div style="color: #10b981; font-weight: 600; font-size: 15px;">
                $${trade.entryPrice?.toFixed(2) || 'N/A'}
              </div>
              ${!isActive && trade.exitPrice ? `
                <div style="color: #888; font-size: 11px; margin-top: 4px;">Exit: $${trade.exitPrice.toFixed(2)}</div>
              ` : ''}
            </div>
