...
const RATE_LIMITS = {
  ...
  // Trading endpoints - generous limits for legitimate use
  placeOrder: { max: 100, window: 60 * 1000, lockout: 60 * 1000 }, // 100 per minute, 1 min lockout
  exitPosition: { max: 100, window: 60 * 1000, lockout: 60 * 1000 }, // 100 per minute, 1 min lockout
